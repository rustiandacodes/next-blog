  ...
  return (
    <div className="h-screen flex justify-center items-center px-5 text-sm">
      <div className="max-w-[500px] w-full md:bg-light-container dark:md:bg-dark-container p-5 px-10 rounded-lg py-12">
        <h1 className="text-center text-2xl font-semibold mb-8">Reset Password</h1>
        <p className="my-5">* Enter your new password here.</p>
        ...
        <button className="w-full bg-primary text-center py-3 mt-3 rounded-lg font-semibold">Submit</button>
